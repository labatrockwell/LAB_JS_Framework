...
// ===========================================
	...
	LAB.BaseApp.prototype.registerMouseEvents = function(){
		...
		window.addEventListener("mousedown", LAB.self.onMousePressed);
		window.addEventListener("mouseup", LAB.self.onMouseReleased);
	}

	LAB.BaseApp.prototype.unregisterMouseEvents = function()
	{
		window.removeEventListener("mousemove", LAB.self.onMouseMoved);
		window.removeEventListener("mousedown", LAB.self.onMousePressed);
		window.removeEventListener("mouseup", LAB.self.onMouseReleased);
	}
